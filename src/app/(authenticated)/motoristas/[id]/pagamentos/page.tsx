  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <input type="date" value={data} onChange={e => setData(e.target.value)}
              className="w-full h-[38px] px-3 border border-[var(--border-strong)] rounded-[4px] bg-surface-raised text-sm outline-none focus:border-[#F97316] focus:border-2" />
          </div>
          <div>
      ...
      {pagamentos.length === 0 ? (
        ...
        <div className="border border-[var(--border-subtle)] rounded-[6px]">
